...
const RecommandedProductDetails = ({product}) => {
    const {toyName, description, price, reviews, imageUrl} = product;

    // window view top 
    const recommendedProductsOverView = () =>{
        window.scrollTo(0,0)
    }
    return (
        <Link onClick={recommendedProductsOverView} to="/recommended_products">
...
export default RecommandedProductDetails;